...
def run_adapt_qaoa(graph, pauli_ops_dict, gradient_ops_dict, max_depth, beta_0=0.0, gamma_0 = 0.01, rel_gtol = 10**-2, etol=-1):
    ...
    while not_converged:
        ...
        # I can update this current density matrix = get opt_qc and cliff_gate
        # store cliff_gate = []
        # store cliff_gate.append(cliff_gate)
        # if store cliff_gate has gates in it, communte those gates with current density matrix
